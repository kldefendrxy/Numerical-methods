...
def common_newtons_method(x0, arr, e=1e-6, max_iter=100):
...
# Тестируем упрощённый метод Ньютона на уравнении x**2 - 5*x + 6 = 0 (корни 2 и 3)
root = common_newtons_method(4, [6, -5, 1], e=1e-6)
